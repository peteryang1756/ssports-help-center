    ...
    <div className="docsRating margin-auto margin-top--lg">
      {haveVoted && !liked ? (
        <div className="text--left">
          Thanks for letting us know! We appreciate your detailed feedback to help us improve our documentation.
          If you have specific suggestions, please let us know through our feedback channels.
        </div>
      ) : haveVoted && liked ? (
